<template>
  <div class="flex justify-start items-center flex-col w-full min-h-[200px] py-[20px]">
    ...
    <div v-for="(i, index) in info" :key="index" @mouseenter="activePreview" @mouseleave="closePreview"
      ...
      class="w-[95%] h-[60px] flex justify-start items-center text-white text-[1.5rem] py-2 px-8 rounded-lg mb-2 cursor-pointer transition-all duration-300 opacity-80 hover:opacity-100">
